...
Creating the intermediate key:
    ...
    nix run nixpkgs#step-cli -- certificate create 'Hillion ACME (warlock.cx.neb.jakehillion.me)' intermediate_cert.pem intermediate_key.pem --kty=EC --curve=P-521 --profile=intermediate-ca --not-after=8760h --ca=$NIXOS_ROOT/modules/ca/cert.pem --ca-key=DOWNLOADED_KEY.pem
