...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    programs.ssh.knownHosts = {
      ...
      "dancefloor.dancefloor.neb.jakehillion.me".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEXkGueVYKr2wp/VHo2QLis0kmKtc/Upg3pGoHr6RkzY";
      ...
      "homeassistant.homeassistant.neb.jakehillion.me".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPM2ytacl/zYXhgvosvhudsl0zW5eQRHXm9aMqG9adux";
